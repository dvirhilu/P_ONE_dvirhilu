...
'''
Creates a dense geometry to be used for generating a single simulation
set. The simulation set will be produced for the dense geometry, and
results for a variety of geometries can be made by masking DOMs from
it.
'''
...
outname = "denseGeo_n" + str(domsPerLine)
...
outfile = dataio.I3File('/home/dvir/workFolder/I3Files/gcd/denseGeo/' + outname, 'w')
