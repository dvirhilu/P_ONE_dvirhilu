...
#SBATCH --mem=8G
#SBATCH --output=/home/dvirhilu/scratch/sbatchLogFiles/nugenStep2/arrayjob_%A_%a.log
#SBATCH --account=rpp-kenclark
#SBATCH --job-name=nugen_step2_%A
#SBATCH --gres=gpu:1
date
